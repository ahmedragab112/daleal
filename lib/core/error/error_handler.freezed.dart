...
class __$$SuccessImplCopyWithImpl<T, $Res>
    extends _$ServerResponseCopyWithImpl<T, $Res, _$SuccessImpl<T>>
...
class _$SuccessImpl<T> implements Success<T> {
  ...
  @override
  String toString() {
    return 'ServerResponse<$T>.data(data: $data)';
  }
...
abstract class Success<T> implements ServerResponse<T> {
...
class __$$FailImplCopyWithImpl<T, $Res>
    extends _$ServerResponseCopyWithImpl<T, $Res, _$FailImpl<T>>
...
class _$FailImpl<T> implements Fail<T> {
  ...
  @override
  String toString() {
    return 'ServerResponse<$T>.error(error: $error)';
  }
...
abstract class Fail<T> implements ServerResponse<T> {
